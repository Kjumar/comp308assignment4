...
exports.trainAndPredictNewData = function(req, res) {
    console.log(irisTesting)
    //
    // convert/setup our data for tensorflow.js
    //
    ...
    async function run() {
        ...
        // const results = model.predict(testingData);
        // console.log(irisTesting.map(item => [
        //     item.sepal_length, item.sepal_width,
        //     item.petal_length, item.petal_width,
        // ])[0]);
        // console.log([
        ...
        // console.log(typeof(req.body.sepal_length));
        const results = model.predict(newData);
